...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <s:include value="/share/btMask.jsp" />
  	<div id="toolbar"></div>
  	<form id="listForm" action="<%=path%>/csms/content/listPagination.v" method="post">
    ...
    $(document).ready(function(){
      ...
      new Toolbar({
        ...
        items : [{
          type:'button',
          text:'新建名片',
          useable : '<s:property value="@com.platform.util.Meta@getOperate(\"cardcontent_new\")"/>',
          position: {
            a: '0px 0px',
            b: '0px -120px'
          },
          handler:function(){
            top.contentFunctions.openSaveContentWindow();
          }
        },'-',{
          type : 'button',
          text : '删除',
