...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    var setting = {
        ...
        var zNodes =[];
        zNodes.push({ id:'-1', pId:'', name:'全部',open : true});
    	zNodes.push({ id:'0', pId:'-1', name:'审核中'});
    	zNodes.push({ id:'1', pId:'-1', name:'审核通过'});
    	zNodes.push({ id:'2', pId:'-1', name:'审核未通过'});
      function treeOnClick(event,treeId,treeNode)
      {
        parent.mainFrame.location = "<%=path%>/csms/content/listPagination.v?type="+(treeNode.id=="-1" ? "" :  treeNode.id);
      }   
