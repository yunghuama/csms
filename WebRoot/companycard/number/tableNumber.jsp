    ...
    $(document).ready(function(){
      ...
      new Toolbar({
        ...
        items : [{
          type:'button',
          text:'新建',
          useable : '<s:property value="@com.platform.util.Meta@getOperate(\"comnumber_new\")"/>',
          position: {
            a: '0px 0px',
            b: '0px -120px'
          },
          handler:function(){
            ...
            type:'button',
            text:'导入',
            useable : '<s:property value="@com.platform.util.Meta@getOperate(\"comnumber_import\")"/>',
            position: {
              a: '0px 0px',
              b: '0px -120px'
            },
          ...
          useable : '<s:property value="@com.platform.util.Meta@getOperate(\"comnumber_delete\")"/>',
          handler : function(){
       	  if(getFirstID()){
          		  var txt = '是否删除该信息？';
                    $.prompt(txt,{
